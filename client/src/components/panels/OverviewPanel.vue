...
.panel-title-bar {
  ...
  flex-shrink: 0;
  border-bottom: 1px solid var(--color-border-default, #e8e8e8);
}
.panel-title-bar .panel-title {
  font-size: var(--font-size-panel-title, 16px);
